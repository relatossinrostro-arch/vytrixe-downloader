...
export default function InstagramVideoDownloader() {
  const howToSchema = {
    ...
    "description": "Learn the simple way to download high-resolution Instagram content using Vytrixe.",
    "step": [
      {
        "@type": "HowToStep",
        "name": "Copy URL from Instagram",
        "text": "Go to the post or Reel and copy the link from the Share menu."
      },
      {
        "@type": "HowToStep",
        "name": "Use Vytrixe Downloader",
        "text": "Open Vytrixe and paste the Reels link into the input field."
      },
      {
        "@type": "HowToStep",
        "name": "Download in HD",
        "text": "Choose the high-definition option and save your video instantly."
      }
    ]
  };
