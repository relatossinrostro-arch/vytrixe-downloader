...
export default function FacebookVideoDownloader() {
  const howToSchema = {
    ...
    "description": "Easy steps to download high-quality videos from Facebook using Vytrixe.",
    "step": [
      {
        "@type": "HowToStep",
        "name": "Get Facebook URL",
        "text": "Click 'Share' on a Facebook video and choose 'Copy Link'."
      },
      {
        "@type": "HowToStep",
        "name": "Paste URL",
        "text": "Paste the copied URL into the Vytrixe search field."
      },
      {
        "@type": "HowToStep",
        "name": "Select Quality",
        "text": "Wait for the video to load and select the quality you want to save."
      }
    ]
  };
