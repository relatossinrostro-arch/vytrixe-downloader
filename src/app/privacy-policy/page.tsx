      ...
      <main className="container mx-auto px-4 py-20 relative z-10">
        <div className="max-w-4xl mx-auto space-y-12">
          ...
          <div className="bg-black/40 backdrop-blur-xl border border-white/10 rounded-[3rem] p-8 md:p-16 space-y-12 leading-relaxed text-gray-400">
            ...
            <section className="space-y-6">
              ...
              <p className="text-sm md:text-base">
                At ViralAuthority PRO PREMIUM, we implement a **transient processing architecture**. This means we do not host or store any multimedia content you process. 
                Our servers act as a secure bridge between the source platform and your device, ensuring total privacy during the archival process.
              </p>
            </section>
            ...
            <section className="space-y-6">
              ...
              <p className="text-sm md:text-base">
                When you access ViralAuthority PRO PREMIUM via Google Login, we only retrieve essential metadata: **Full Name, Email Address, and Avatar**. 
            ...
            <section className="space-y-6">
              ...
              <p className="text-sm md:text-base">
                Payment data is handled directly by **PayPal Checkout**. ViralAuthority PRO PREMIUM never receives or stores your credit card details. 
          ...
          <div className="text-center space-y-2">
            ...
            <p className="text-blue-500 font-bold hover:underline cursor-pointer">legal@viralauthoritypro.pro</p>
          </div>
